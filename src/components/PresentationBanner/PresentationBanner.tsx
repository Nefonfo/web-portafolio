...
const ContactIcons = () => (
    <div className="fixed top-4 left-4 flex justify-center gap-x-4 z-30">
        <ContactIcon href='https://github.com/Nefonfo' btnColor='btn-primary'>
            <svg
                xmlns="http://www.w3.org/2000/svg"
                className='w-8 h-8 fill-primary-content'
                viewBox="0 0 24 24"
            >
        ...
        <ContactIcon href='https://www.linkedin.com/in/nefonfo/' btnColor='btn-info'>
            <svg
                xmlns="http://www.w3.org/2000/svg"
...
export const PresentationBanner = () => {
    ...
    return (
        <div className='h-[200vh] w-full' ref={container}>
            <ContactIcons />
            <div className='w-full sticky top-64 flex flex-col justify-center gap-y-5'>
